...
class ChannelController {
    ...
    async getById(req, res, next) {
        try {
            ...
            const channel_found = await channelService.getById(workspace._id, channel._id)
    ...
    async softDelete(req, res, next) {
        try {
            ...
            const channel_found = await channelService.softDelete(workspace._id, channel._id)
    ...
    async delete(req, res, next) {
        try {
            ...
            const channel_found = await channelService.delete(workspace._id, channel._id)
